      ...
      <div className="bg-white p-8 rounded-lg shadow-md max-w-2xl w-full">
        ...
        {step === "pharmacy" && (
          <form onSubmit={handlePharmacyNext} noValidate>
            ...
            <InputField id="pharmacyName" label="Pharmacy name" placeholder="e.g. Kigali Pharmacy" value={pharmacy.pharmacyName} onChange={(v) => updatePharmacy("pharmacyName", v)} error={errors.pharmacyName} required />
            ...
            <InputField id="contactEmail" label="Contact email" type="email" placeholder="pharmacy@example.com" value={pharmacy.contactEmail} onChange={(v) => updatePharmacy("contactEmail", v)} error={errors.contactEmail} required />
