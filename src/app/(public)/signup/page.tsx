          ...
          {step === "personal" && (
            <div className="space-y-6 animate-in fade-in duration-500">
              ...
              <div className="grid grid-cols-2 gap-4">
                <InputField label="First name" required value={formData.firstName} onChange={(v) => updateData({ firstName: v })} />
                <InputField label="Last name" required value={formData.lastName} onChange={(v) => updateData({ lastName: v })} />
              </div>
              ...
              <div className="pt-6 border-t border-gray-100">
                ...
                <InputField label="Contact name" required className="mb-4" value={formData.emergencyName} onChange={(v) => updateData({ emergencyName: v })} />
                <InputField label="Contact phone" required value={formData.emergencyPhone} onChange={(v) => updateData({ emergencyPhone: v })} />
              </div>
          ...
          {step === "location" && (
            <div className="space-y-6 animate-in fade-in duration-500">
              ...
              <div className="space-y-4">
                <InputField label="Address" required value={formData.address} onChange={(v) => updateData({ address: v })} />
                <InputField label="Street address" required value={formData.street} onChange={(v) => updateData({ street: v })} />
                <div className="grid grid-cols-2 gap-4">
                  <InputField label="City" required value={formData.city} onChange={(v) => updateData({ city: v })} />
                  <InputField label="District" required value={formData.district} onChange={(v) => updateData({ district: v })} />
                </div>
              </div>
